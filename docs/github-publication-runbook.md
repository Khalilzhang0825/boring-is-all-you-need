...
The release artifact must be built by `.github/workflows/release.yml` from the exact `v2.0.0` tag. Do not upload a locally assembled replacement archive.
...
if ($LiveTagSha.Trim() -ne $ReviewedSha -or $LiveMainSha.Trim() -ne $ReviewedSha) {
  throw "Live v2.0.0 or main moved away from the reviewed commit."
}
